        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('barang.masuk') }}">Barang Masuk</a></li>
                    <li class="breadcrumb-item active">Riwayat</li>
                </ol>
            </nav>
            <h1 class="page-title">Riwayat Barang Masuk</h1>
            <p class="page-subtitle">Histori transaksi barang masuk</p>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="stat-value mb-0">{{ $barangMasuk->count() }}</h3>
                    </div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <form action="{{ route('barang.masuk.riwayat') }}" method="GET" class="d-flex flex-wrap gap-2">
            <div class="input-group input-group-sm" style="width: 250px;">
                <span class="input-group-text"><i class="bi bi-search"></i></span>
                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari barcode atau nama..." class="form-control">
                @if(isset($search) && $search)
                <a href="{{ route('barang.masuk.riwayat') }}" class="btn btn-outline-secondary" title="Clear">
            ...
            <table class="table table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><i class="bi bi-plus-circle me-1"></i>Jumlah</th>
