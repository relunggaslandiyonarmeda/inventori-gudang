...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('laporan.keluar.pdf', ['bulan' => $bulan, 'tahun' => $tahun]) }}" class="btn btn-danger">
                <i class="bi bi-file-pdf me-1"></i>PDF
            </a>
            <a href="{{ route('laporan.keluar.excel', ['bulan' => $bulan, 'tahun' => $tahun]) }}" class="btn btn-success">
                <i class="bi bi-file-excel me-1"></i>Excel
            </a>
            <a href="{{ route('laporan.keluar.csv', ['bulan' => $bulan, 'tahun' => $tahun]) }}" class="btn btn-primary">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="stat-value mb-0">{{ $barangKeluars->count() }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="stat-value mb-0">{{ number_format($totalKeluar) }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="stat-value mb-0">{{ $barangKeluars->count() > 0 ? round($totalKeluar / $barangKeluars->count()) : 0 }}</h3>
                    </div>
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            <div class="text-muted">
                                ...
                                <p class="mb-0">Tidak ada transaksi barang keluar pada periode ini</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
