...
<div class="text-center mb-4 sm:mb-6">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Laporan Barang Keluar</h1>
...
<div class="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        <a href="{{ route('laporan.keluar.pdf', ['bulan' => $bulan, 'tahun' => $tahun]) }}" 
        ...
        <a href="{{ route('laporan.keluar.excel', ['bulan' => $bulan, 'tahun' => $tahun]) }}" 
        ...
        <a href="{{ route('laporan.keluar.csv', ['bulan' => $bulan, 'tahun' => $tahun]) }}" 
        ...
        <table class="w-full table-auto">
            ...
            <tfoot>
                <tr class="bg-gray-200 font-bold">
                    ...
                    <td class="px-4 py-2 text-center text-red-600">{{ $totalKeluar }}</td>
                    <td></td>
                </tr>
            </tfoot>
        </table>
