...
<div class="text-center mb-4 sm:mb-6">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Barang Keluar</h1>
    <p class="text-gray-600 text-sm sm:text-base">Kurangi stok barang dengan scan barcode</p>
</div>
...
<div id="scan-tab" class="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
    <h2 class="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Kurangi Stok (Scan Barcode)</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div>
            <form action="{{ route('barang.keluar.store') }}" method="POST">
                ...
                <div class="mb-3 sm:mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-1 sm:mb-2">Jumlah Keluar</label>
                    <input type="number" name="jumlah_keluar" min="1" value="1" required
                        class="w-full px-3 sm:px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 input-mobile"
...
<div id="manual-tab" class="hidden">
    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
        <h2 class="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Kurangi Stok (Manual Search)</h2>
        ...
        <form action="{{ route('barang.keluar.manual') }}" method="POST" id="manual-form">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2">Jumlah Keluar</label>
                <input type="number" name="jumlah_keluar" min="1" value="1" required
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Masukkan jumlah">
            </div>
